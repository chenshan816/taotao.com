...
<body id="mainframe">
	...
	<div class="w" id="headers">
		<div id="logo">
			<a href="/"><img alt="淘淘商城" src="/images/taotao-logo.gif"></a>
		</div>
			...
			<div class="mc" id="success_detail">
				<ul class="list-order">
					<li class="li-st">
						...
						<div class="fore3">淘淘快递 &nbsp; 送货时间: 预计 ${date} 送达&nbsp;</div>
					</li>
				</ul>

				<div id="bookDiv">
					<div class="mt">
						<div id="paySuccess" style="visibility: hidden;">
							<s class="icon-succ02"></s>
							<p class="ftx-02">您的订单已经在处理中，发货后订单内容会显示承运人联系方式，如有必要您可以联系对方</p>
						</div>
					</div>
					<div id="payFail" style="visibility: hidden;">
						<div class="mt" id="success_tittle">
							<s class="icon-wrong02"></s>
							<p class="i-tips01">您的订单付款失败，如果存在问题请联系客服</p>
						</div>
					</div>
					<div id="payImage" style="visibility: visible;">
						<!-- 在线支付按钮  -->
						<img style="vertical-align: middle;" src="${qrUrl}" alt="支付码" />
					</div>
				</div>
			</div>
		</div>
